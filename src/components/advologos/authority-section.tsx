...
function TestimonialCarousel() {
  ...
  return (
    <div
      className="bg-[rgba(255,255,255,0.025)] border border-[rgba(184,196,204,0.1)] p-1.25 rounded-[1.25rem] overflow-hidden card-glow"
      onMouseEnter={() => setIsPaused(true)}
      onMouseLeave={() => setIsPaused(false)}
    >
      <div
        className="bg-[var(--ardosia)] rounded-[calc(1.25rem-5px)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.06)] p-7 min-h-[220px] flex flex-col"
      ...
      >
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="flex-1 flex flex-col testimonial-swipe"
            style={{ transform: swipeOffset ? `translateX(${swipeOffset}px)` : undefined }}
          >
            <blockquote className="relative font-serif text-[17px] italic text-[var(--prata-lt)] leading-[1.5] mb-3.5 pt-5">
            ...
            <div className="flex flex-col items-center gap-2.5">
              <div className="relative">
                ...
                <div className="w-[52px] h-[52px] rounded-full p-[2px]" style={{ background: 'radial-gradient(circle at 30% 30%, var(--crimson), rgba(139,30,45,0.15), transparent)' }}>
                  <div className="w-full h-full rounded-full bg-[var(--ardosia)] flex items-center justify-center text-[var(--crimson-lt)] text-[15px] font-bold font-serif">
                    {initials}
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center gap-0.5">
                <span className="font-serif italic text-[13px] text-[var(--crimson-lt)]">
                  {t.author}
                </span>
                <cite className="text-[11px] text-[var(--nevoa)] not-italic tracking-[0.06em] uppercase">
                  {t.role}
                </cite>
              </div>
            </div>
        ...
        {/* Dots */}
        <div className="flex gap-2 justify-center mt-5 pt-4 border-t border-[rgba(184,196,204,0.06)]">
          {TESTIMONIALS.map((_, i) => (
            <button
              ...
              className={`h-[6px] rounded-full transition-all duration-300 ${
                i === current
                  ? 'w-[24px] bg-[var(--crimson)]'
                  : 'w-[6px] bg-[rgba(184,196,204,0.2)] hover:bg-[rgba(184,196,204,0.35)]'
              }`}
            />
          ))}
        </div>
            ...
            <ScrollReveal delay={2}>
              <div className="flex flex-col gap-2.5">
                ...
                <div className="bg-[rgba(255,255,255,0.025)] border border-[rgba(184,196,204,0.08)] p-1 rounded-[1rem]">
                  <div className="bg-[var(--ardosia-md)] rounded-[calc(1rem-4px)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.04)] px-4 py-3 md:px-5 md:py-4">
                    <div className="text-[9px] font-bold tracking-[0.16em] uppercase text-[var(--crimson-lt)] mb-1.5">
                      Conformidade OAB
                    </div>
                    <p className="text-[12px] text-[var(--prata)] leading-[1.5] !max-w-none">
                      Todo o trabalho desenvolvido pela Advologos respeita integralmente o{' '}
                      <strong>Provimento 205/2021</strong> do Conselho Federal da OAB — que regulamenta a publicidade e o marketing na advocacia. Nenhuma entrega viola as regras de publicidade ética da profissão.
                    </p>
                  </div>
                </div>
              </div>
