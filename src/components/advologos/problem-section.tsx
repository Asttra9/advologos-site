...
function StatCard({ stat }: { stat: (typeof SIGNALS)[number] }) {
  ...
  return (
    ...
    >
        ...
        <AnimatedNumber
          value={stat.value}
          suffix={stat.suffix}
          className="font-serif text-[clamp(42px,5.8vw,64px)] font-normal text-[var(--crimson-lt)] leading-none tracking-[-0.03em] flex-shrink-0 relative z-[2] min-w-[86px]"
        />
